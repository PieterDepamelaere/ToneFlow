...
class TFNDIconLabel(ILeftBody, MDLabel):
    pass


class TFNDBadgeLabel(IRightBody, MDLabel):
    pass


class TFNavigationDrawerHeaderBase:
    """
...
class TFNavigationDrawerToolbar(MDToolbar, TFNavigationDrawerHeaderBase):
    def _update_specific_text_color(self, instance, value):
        pass


class TFNavigationDrawerIconButton(OneLineIconListItem):
...
class TFNavigationDrawerSubheader(OneLineListItem):
    """
...
class TFNavigationDrawerDivider(OneLineListItem):
    """
...
class TFNavigationLayout(VendorNavigationDrawer, ThemableBehavior):
