...
class TFActionBottomAppBarButton(MDFloatingActionButton):
...
ThemableBehavior, RectangularElevationBehavior, MDBoxLayout,
    ...
    def __init__(self, **kwargs):
        self.action_button = TFActionBottomAppBarButton()
...
class MDBottomAppBar(FloatLayout):
    ...
    def add_widget(self, widget, index=0, canvas=None):
        if widget.__class__ is TFToolbar:
